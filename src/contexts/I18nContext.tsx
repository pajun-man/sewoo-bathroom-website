...
const translations: Record<string, Record<Language, string>> = {
  ...
  '品质至上': { zh: '品质至上', en: 'Quality First' },
  '技术创新': { zh: '技术创新', en: 'Technological Innovation' },
  '客户为本': { zh: '客户为本', en: 'Customer Oriented' },
  '全球布局': { zh: '全球布局', en: 'Global Layout' },
  '严格质量管控体系，确保每件产品达到国际标准。': { zh: '严格质量管控体系，确保每件产品达到国际标准。', en: 'Strict quality control system ensures every product meets international standards.' },
  '持续研发投入，掌握核心技术，提供OEM/ODM定制服务。': { zh: '持续研发投入，掌握核心技术，提供OEM/ODM定制服务。', en: 'Continuous R&D investment, mastering core technologies, providing OEM/ODM customization services.' },
  '以客户需求为导向，提供一站式供应链解决方案。': { zh: '以客户需求为导向，提供一站式供应链解决方案。', en: 'Customer demand-oriented, providing one-stop supply chain solutions.' },
  '五大生产基地，覆盖全球50+国家市场。': { zh: '五大生产基地，覆盖全球50+国家市场。', en: 'Five production bases covering over 50 countries worldwide.' },
  '在联系我们之前，您可以先查看我们的常见问题解答，或许能找到您需要的答案。': { zh: '在联系我们之前，您可以先查看我们的常见问题解答，或许能找到您需要的答案。', en: 'Before contacting us, you can check our frequently asked questions. You may find the answer you need.' },
