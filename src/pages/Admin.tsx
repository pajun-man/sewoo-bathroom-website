    ...
    const defaultFactories: Factory[] = [
      {
        ...
        videos: [],
        phone: '400-888-8001',
        phoneEn: '+86 400-888-8001',
        email: 'shower@sewoo.com',
        emailEn: 'shower@sewoo.com',
        workingHours: '周一至周六 8:00-18:00',
        workingHoursEn: 'Mon-Sat 8:00-18:00',
        certifications: [
          { name: 'ISO9001', nameEn: 'ISO9001', icon: 'Award' },
          { name: 'CE认证', nameEn: 'CE Certified', icon: 'Award' },
          { name: 'ROHS', nameEn: 'ROHS', icon: 'Award' },
        ],
        factoryArea: '50,000',
        factoryAreaEn: '平方米厂房面积',
        technicalStaff: '200+',
        technicalStaffEn: '专业技术人员',
        exportCountries: '50+',
        exportCountriesEn: '出口国家',
        patentTechnologies: '100+',
        patentTechnologiesEn: '专利技术',
        factoryStrengthTitle: '工厂实力展示',
        factoryStrengthTitleEn: 'Factory Strength',
      },
      {
        id: '2',
        name: '陶瓷洁具工厂',
        ...
        videos: [],
        phone: '400-888-8002',
        phoneEn: '+86 400-888-8002',
        email: 'ceramic@sewoo.com',
        emailEn: 'ceramic@sewoo.com',
        workingHours: '周一至周六 8:00-18:00',
        workingHoursEn: 'Mon-Sat 8:00-18:00',
        certifications: [
          { name: 'ISO9001', nameEn: 'ISO9001', icon: 'Award' },
          { name: 'ISO14001', nameEn: 'ISO14001', icon: 'Award' },
        ],
        factoryArea: '80,000',
        factoryAreaEn: '平方米厂房面积',
        technicalStaff: '300+',
      ...
      },
      {
        ...
        videos: [],
        phone: '400-888-8003',
        phoneEn: '+86 400-888-8003',
        email: 'smart@sewoo.com',
        emailEn: 'smart@sewoo.com',
        workingHours: '周一至周六 8:00-18:00',
        workingHoursEn: 'Mon-Sat 8:00-18:00',
        certifications: [
          { name: 'ISO9001', nameEn: 'ISO9001', icon: 'Award' },
          { name: 'CE认证', nameEn: 'CE Certified', icon: 'Award' },
          { name: 'CCC认证', nameEn: 'CCC Certified', icon: 'Award' },
        ],
        factoryArea: '30,000',
        factoryAreaEn: '平方米厂房面积',
        technicalStaff: '150+',
      ...
      },
      {
        ...
        videos: [],
        phone: '400-888-8004',
        phoneEn: '+86 400-888-8004',
        email: 'showerhead@sewoo.com',
        emailEn: 'showerhead@sewoo.com',
        workingHours: '周一至周六 8:00-18:00',
        workingHoursEn: 'Mon-Sat 8:00-18:00',
        certifications: [
          { name: 'ISO9001', nameEn: 'ISO9001', icon: 'Award' },
          { name: 'NSF认证', nameEn: 'NSF Certified', icon: 'Award' },
        ],
        factoryArea: '40,000',
        factoryAreaEn: '平方米厂房面积',
        technicalStaff: '180+',
      ...
      },
      {
        ...
        videos: [],
        phone: '400-888-8005',
        phoneEn: '+86 400-888-8005',
        email: 'furniture@sewoo.com',
        emailEn: 'furniture@sewoo.com',
        workingHours: '周一至周六 8:00-18:00',
        workingHoursEn: 'Mon-Sat 8:00-18:00',
        certifications: [
          { name: 'ISO9001', nameEn: 'ISO9001', icon: 'Award' },
          { name: 'CARB认证', nameEn: 'CARB Certified', icon: 'Award' },
        ],
        factoryArea: '25,000',
        factoryAreaEn: '平方米厂房面积',
        technicalStaff: '120+',
