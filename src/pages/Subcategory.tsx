...
const Subcategory = () => {
  ...
  const filteredProducts = dataSource.filter((p: any) => p.subcategory === decodedSubcategory);
  
  const category = dataSource.find((p: any) => p.subcategory === decodedSubcategory)?.category || '产品';
